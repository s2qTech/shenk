...
The 2026-08-30 Today/Data interaction follow-up integrates morning measurements into a compact summary card and gives empty, running, failed, and complete coach-review states one stable provider-aware card anatomy. Data now treats horizontal motion exclusively as metric navigation: its four tabs and chart pages share a continuously animated pager state, while incidental sideways movement and scrim taps cannot dismiss the sheet. Only system back or an explicit downward drag from the sheet handle closes Data. Xiaomi 14 verification covered linked weight/body-fat/muscle transitions, both dismissal paths, same-certificate data-preserving installation, and an empty crash buffer; no review or business mutation was triggered.
