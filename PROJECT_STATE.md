...
Package 4 is ready but not started: Calendar, records, and data. It must build on the Package 2 repository and Package 3 Today models, preserve actual > effective formal plan > fallback suggestion priority, and keep correction writes local-first. Native timer execution, plan inbox, and AI review remain outside Package 4.
